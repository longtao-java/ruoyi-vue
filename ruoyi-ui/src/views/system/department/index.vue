<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="deppath">
        <el-input
          v-model="queryParams.deppath"
          placeholder="请输入${comment}"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="${comment}" prop="isparent">
        <el-input
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="deppath" />
      <el-table-column label="${comment}" align="center" prop="enabled" />
      <el-table-column label="${comment}" align="center" prop="isparent" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="deppath">
          <el-input v-model="form.deppath" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="enabled">
          <el-input v-model="form.enabled" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="isparent">
          <el-input v-model="form.isparent" placeholder="请输入${comment}" />
        </el-form-item>
      </el-form>
