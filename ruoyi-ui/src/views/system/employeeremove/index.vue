  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="调动后部门" prop="afterdepid">
        <el-input
          v-model="queryParams.afterdepid"
      ...
      <el-form-item label="调动后职位" prop="afterjobid">
        <el-input
          v-model="queryParams.afterjobid"
      ...
      <el-form-item label="调动日期" prop="removedate">
        <el-date-picker clearable
          v-model="queryParams.removedate"
          type="date"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:employeeremove:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:employeeremove:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:employeeremove:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:employeeremove:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="employeeremoveList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="调动后部门" align="center" prop="afterdepid" />
      <el-table-column label="调动后职位" align="center" prop="afterjobid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="调动后部门" prop="afterdepid">
          <el-input v-model="form.afterdepid" placeholder="请输入调动后部门" />
        </el-form-item>
        <el-form-item label="调动后职位" prop="afterjobid">
          <el-input v-model="form.afterjobid" placeholder="请输入调动后职位" />
        </el-form-item>
        <el-form-item label="调动日期" prop="removedate">
          <el-date-picker clearable
...
<script>
import { listEmployeeremove, getEmployeeremove, delEmployeeremove, addEmployeeremove, updateEmployeeremove } from "@/api/system/employeeremove";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listEmployeeremove(this.queryParams).then(response => {
        this.employeeremoveList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateEmployeeremove(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addEmployeeremove(this.form).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/employeeremove/export', {
        ...this.queryParams
