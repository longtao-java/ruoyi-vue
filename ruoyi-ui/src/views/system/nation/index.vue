    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:nation:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listNation, getNation, delNation, addNation, updateNation } from "@/api/system/nation";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/nation/export', {
        ...this.queryParams
