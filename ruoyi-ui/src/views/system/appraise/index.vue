<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="appraiseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="考评日期" align="center" prop="appdate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.appdate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="考评结果" align="center" prop="appresult" />
      <el-table-column label="考评内容" align="center" prop="appcontent" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="考评结果" prop="appresult">
          <el-input v-model="form.appresult" placeholder="请输入考评结果" />
        </el-form-item>
