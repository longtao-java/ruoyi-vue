...
public class SysmsgController extends BaseController
{
     ...
     * 查询【请填写功能名称】列表
     */
    @PreAuthorize("@ss.hasPermi('system:sysmsg:list')")
    @GetMapping("/list")
     ...
     * 导出【请填写功能名称】列表
     */
    @PreAuthorize("@ss.hasPermi('system:sysmsg:export')")
     ...
     * 获取【请填写功能名称】详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:sysmsg:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('system:sysmsg:add')")
     ...
     * 修改【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('system:sysmsg:edit')")
     ...
     * 删除【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('system:sysmsg:remove')")
